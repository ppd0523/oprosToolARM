...
#ifndef	_MOBILE_CONTROLLER_H_
#define	_MOBILE_CONTROLLER_H_
...
public:
	...
	//2015.07.14 mskim
	virtual int32_t MoveBase( float64_t distance, float64_t linearVelocity ) { return API_NOT_SUPPORTED; }
	//virtual int32_t DriveBase(float64_t linearVelocity, float64_t angularVelocity);
	virtual int32_t IsBaseRunning(bool& isWheelRunning) { return API_NOT_SUPPORTED; }
};
#endif	//	_MOBILE_CONTROLLER_H_