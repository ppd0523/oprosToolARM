#ifndef _VisionRecognitionResultData_REQUIRED_PORT_H
#define _VisionRecognitionResultData_REQUIRED_PORT_H

#include <ApiTypes.h>

namespace OPRoS
{
class VisionRecognitionResultData
{
public:
	VisionRecognitionResultData(void)
	{
	}
	virtual ~VisionRecognitionResultData(void) { }
	...
	VisionRecognitionResultData operator=(const VisionRecognitionResultData &visionRecognitionData)
	{
...
inline std::string typeName(VisionRecognitionResultData *p)	{ return "VisionRecognitionResultData"; }
}
