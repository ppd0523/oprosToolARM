...
// DeviceAPI0.998에 맞게 ObjectPosition 타입 추가 , KJS (20140710)
#pragma once
...
public:
	...
	ObjectPosition(float64_t x, float64_t y, float64_t z, float64_t roll, float64_t pitch, float64_t yaw) {
		this->x = x;
		this->y = y;
		this->z = z;
		this->roll = roll;
	...
	ObjectPosition operator=(const ObjectPosition &arg)
	{
		this->x = arg.x;
		this->y = arg.y;
		this->z = arg.z;
